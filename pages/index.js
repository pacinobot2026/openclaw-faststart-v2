  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 relative">
        ...
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 pointer-events-none" style={{width: '500px', height: '500px', opacity: 0.3}}>
          <style jsx>{`
            .orbit-center {
              position: absolute;
              top: 50%;
            ...
            .orbit-agent {
              ...
              animation: orbit linear infinite, agentGlow 2s ease infinite;
            }
            ...
            .agent-1 { background: rgba(0,212,255,0.2); border: 2px solid #00d4ff; color: #00d4ff; animation-duration: 18s; }
            .agent-2 { background: rgba(255,107,107,0.2); border: 2px solid #ff6b6b; color: #ff6b6b; animation-duration: 22s; animation-delay: -5s; }
            .agent-3 { background: rgba(168,85,247,0.2); border: 2px solid #a855f7; color: #a855f7; animation-duration: 20s; animation-delay: -10s; }
            .agent-4 { background: rgba(255,193,7,0.2); border: 2px solid #ffc107; color: #ffc107; animation-duration: 24s; animation-delay: -15s; }
            .agent-5 { background: rgba(0,230,118,0.2); border: 2px solid #00e676; color: #00e676; animation-duration: 16s; animation-delay: -8s; }
            .agent-6 { background: rgba(233,30,99,0.2); border: 2px solid #e91e63; color: #e91e63; animation-duration: 21s; animation-delay: -12s; }
          `}</style>
          
          <div className="orbit-center">🤖</div>
          <div className="orbit-ring" style={{width: '200px', height: '200px'}}></div>
          <div className="orbit-ring" style={{width: '300px', height: '300px'}}></div>
          <div className="orbit-ring" style={{width: '400px', height: '400px'}}></div>
          ...
          <div className="orbit-agent agent-5">💻</div>
          <div className="orbit-agent agent-6">🎨</div>
        </div>
