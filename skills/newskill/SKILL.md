...
## 📖 LESSONS ENDPOINTS (1) ⭐ NEW

### 12. POST /create-lesson
...
| `long_description` | string | No | Full lesson content |
| `type` | string | No | Lesson type (default: `video`) |
| `video_name` | string | No | Name for the video in library |
| `video_url` | string | No | Video URL or code (used to link/create video) |
| `video_tags` | array | No | Tags for the video |
...
```json
{
  ...
  "lesson_id": 15,
  "type": "points",
  "description": "Complete the intro lesson",
  "points": 10
}
```
...
**⭐ = New endpoint discovered in this ingestion**
...
*Skill updated: 2026-02-12 | Endpoints: 16 | Source: https://api.coursesprout.com/ai-api-docs*
